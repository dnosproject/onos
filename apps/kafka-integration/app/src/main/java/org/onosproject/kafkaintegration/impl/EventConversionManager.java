...
import org.onosproject.kafkaintegration.converter.PacketEventConverter;
...
import static org.onosproject.kafkaintegration.api.dto.OnosEvent.Type.PACKET;
...
public class EventConversionManager implements EventConversionService {
    ...
    private EventConverter packetEventConverter;
    ...
    protected void activate() {
        ...
        packetEventConverter = new PacketEventConverter();
    ...
    @Override
    public OnosEvent convertEvent(PacketContext context) {
        return new OnosEvent(PACKET, packetEventConverter.convertToProtoMessage(context));
    }
